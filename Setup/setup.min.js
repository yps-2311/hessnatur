!function(e){function t(t){e.iridion.push(["goal",t])}function n(e){(document.attachEvent?"complete"===document.readyState:"loading"!==document.readyState)?e():document.addEventListener("DOMContentLoaded",e)}function r(e){for(var t=document.cookie.split(";"),n=0;n<t.length;n++)if(t[n].substr(0,t[n].indexOf("=")).replace(/^\s+|\s+$/g,"")===e)return decodeURIComponent(t[n].substr(t[n].indexOf("=")+1))}function o(t){e.iridion.push(["segment",String(t)])}Element.prototype.matches||(Element.prototype.matches=Element.prototype.msMatchesSelector||Element.prototype.webkitMatchesSelector),Element.prototype.closest||(Element.prototype.closest=function(e){var t=this;do{if(t.matches(e))return t;t=t.parentElement||t.parentNode}while(null!==t&&1===t.nodeType);return null});try{var i=r("iridion_user");i&&-1!==i.indexOf("1521023056101454")&&(e.document.cookie="iridion_exclude=true; expires=Thu, 18 Dec 2022 12:00:00 UTC; domain=.hessnatur.com; path=/")}catch(e){}try{var a=document.URL,c=e.location.pathname;if(new RegExp(/.*hessnatur.com\/de\/?($|((\?|\#).*))/).test(a))t("page_home");else if(-1!==a.indexOf("/p/")){t("page_pds");var s=XMLHttpRequest.prototype.open;XMLHttpRequest.prototype.open=function(e,n,r,o,i){this.addEventListener("loadend",(function(){4===this.readyState&&-1!==n.indexOf("https://www.hessnatur.com/de/cart/add")&&t("click_addToCart")}),!1),s.call(this,e,n,r,o,i)}}else if("/de/NEU"===c||"/de/damen"===c||"/de/herren"===c||"/de/outdoor"===c||"/de/baby"===c||"/de/home"===c||"/de/sale"===c)t("page_lp_cat");else if(-1!==a.indexOf("/c/"))t("page_cat"),n((function(){try{var e=document.querySelector("#tabFilter-label"),n=setInterval((function(){if(void 0!==e){clearInterval(n);var r=e.querySelector("strong");void 0!==r&&(-1===r.innerHTML.indexOf("(0)")&&-1===r.innerHTML.indexOf(">0<")&&t("filter_genutzt"),e.addEventListener("click",(function(){t("filter_click")})))}}),100);setTimeout((function(){clearInterval(n)}),1e4)}catch(e){t("error_setup"),t("error_setup1a")}try{var r=document.querySelector("#tabSort-label"),o=setInterval((function(){void 0!==r&&(clearInterval(o),r.addEventListener("click",(function(){t("cat_click_sort")})))}),100);setTimeout((function(){clearInterval(o)}),1e4)}catch(e){t("error_setup"),t("error_setup2a")}}));else if(-1!==a.indexOf("/de/cart"))t("page_cart"),document.addEventListener("click",(function(n){var r=n.target;r.closest("#hessnaturVoucherForm .quickadd__button")?e.iridion.push(["goal","aktionscode","",!0]):r.closest(".js-entry-edit-save")&&t("nutzeEinstellungen")}));else if(-1!==a.indexOf("/register/guest-update"))t("page_guest");else if(-1!==a.indexOf("/register"))t("page_reg");else if(-1!==a.indexOf("/login")){t("page_signin");var l=setInterval((function(){var n=e.document.querySelector("#loginForm .text-right .button");n&&(clearInterval(l),n.addEventListener("click",(function(){t("page_login")})))}),100);setTimeout((function(){clearInterval(l)}),5e3)}else if(-1!==a.indexOf("/merkzettel"))t("click_merken");else if(-1!==a.indexOf("/addresses/add-delivery-address"))t("page_address");else if(-1!==a.indexOf("/payment/add-payment-method"))t("page_pay");else if(-1!==a.indexOf("/search"))t("page_suche");else if(-1!==a.indexOf("/summary")){t("page_sum");try{n((function(){var t=e.document.querySelectorAll("#checkoutContentPanel > div > .row > div .h-smallOffset-bottom-inner");0!==t.length&&-1!==t[0].textContent.trim().toLowerCase().indexOf("rechnung")&&e.localStorage.setItem("kk_buytype","rechnung")}))}catch(e){t("error_setup"),t("error_setup3")}}else if(-1!==a.indexOf("/checkout/orderConfirmation")){t("page_conv"),e.localStorage.setItem("kk_hasbought",!0),e.localStorage.removeItem("kk_upsell_hide");var u=setInterval((function(){try{if(void 0!==e.emospro){var n=0,r="";e.emospro.billing&&e.emospro.billing.length>3&&(clearInterval(u),n=e.emospro.billing[3],r=e.emospro.billing[0]),0===n&&e.emospro.ec_Event&&e.emospro.ec_Event.length>0&&(clearInterval(u),n=e.emospro.ec_Event[0].price),0!==parseInt(n)?e.iridion.push(["revenue",n,r]):t("error_revenue")}}catch(e){t("error_revenue")}}),100);setTimeout((function(){clearInterval(u)}),3e3),"rechnung"===e.localStorage.getItem("kk_buytype")&&(e.iridion.push(["segment","32785"]),e.localStorage.removeItem("kk_buytype"));try{e.iridion.push(["profile","setValue","hasbought","true"])}catch(e){}}-1!==e.document.location.search.indexOf("layer=")&&(e.document.cookie="kk_newsletter=true; expires=Thu, 18 Dec 2022 12:00:00 UTC; path=/"),n((function(){try{for(var e=document.querySelectorAll(".breadcrumbs *"),n=e.length,r=0;r<n;r++)e[r].addEventListener("click",(function(){t("breadcrumb")}));document.querySelector('a[data-toggle="offCanvasLeft"]')&&document.querySelector('a[data-toggle="offCanvasLeft"]').addEventListener("click",(function(){t("burgermenu")}))}catch(e){t("error_setup"),t("error_setup4")}}));try{e.localStorage.getItem("kk_hasbought")&&e.iridion.push(["profile","setValue","hasbought","true"])}catch(e){}}catch(e){t("error_setup"),t("error_setup5")}try{var d=e.document.referrer,m=e.document.location,p=e.document.cookie;-1!==d.indexOf(".google.")||-1!==d.indexOf(".bing.")?o(32804):-1!==d.indexOf(".facebook.")||-1!==d.indexOf(".instagram.")?o(32805):-1!==d.indexOf(".hessnatur.com/magazin/")&&o(32806),-1===m.pathname.indexOf("/newsletter/doi/einstellungen")&&-1===m.search.indexOf("?newsletter=")||o(32803),n((function(){for(var t=e.document.querySelectorAll('.js-product-reference[data-componentid="CrossSellingEconda"] .item__image'),n=0;n<t.length;n++)t[n].addEventListener("click",(function(){o(32802)}))})),-1===p.indexOf("kk_visitor_firstsession")?-1===p.indexOf("kk_visitor_returning")?(o(32800),e.document.cookie="kk_visitor_firstsession="+new Date+";domain=.hessnatur.com;path=/",e.document.cookie="kk_visitor_returning=true;domain=.hessnatur.com;path=/;expires=Thu, 18 Dec 2025 12:00:00 UTC"):(o(32801),f=32800,e.iridion.push(["removeSegment",String(f)])):new Date-new Date(r("kk_visitor_firstsession"))<144e5||(e.document.cookie="kk_visitor_firstsession=false;domain=.hessnatur.com;path=/;expires=Thu, 18 Dec 2000 12:00:00 UTC")}catch(e){t("error_setup"),t("error_setup6")}var f}(window);
