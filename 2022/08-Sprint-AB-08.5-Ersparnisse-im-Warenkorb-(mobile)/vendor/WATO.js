...
(function(window, document) {
    ...
    window.WATO.prototype.elem = function(waitFor, callback, timeout, self, time) {
        ...
        if (Date.now() - _time > 30000) {  // TODO: zurück auf 10000 setzen
    ...
    */
	...
	window.WATO.prototype.xhr_get2 = function(url, scopedData, callback) {
	...
	window.WATO.prototype.xhr_post2 = function(url, payload, callback, scopedData) {
        var request = new XMLHttpRequest();
