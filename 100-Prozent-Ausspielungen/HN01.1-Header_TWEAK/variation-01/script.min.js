!function(e,t){"use strict";void 0===e.WATO&&(e.WATO=function(){}),e.WATO.prototype.elem=function(e,o,n,a,i){var l,r=this||a,d=i||Date.now(),c=!1;return Date.now()-d>1e4?(o(!1),!1):("string"==typeof e?c=(l=t.querySelectorAll(e)).length>0:l=c=!0===e(),!0===c?o(l):setTimeout(r.elem.bind(null,e,o,n,r,d),n||20))},e.WATO.prototype.qs=function(e,o){return(o||t).querySelector(e)},e.WATO.prototype.qsa=function(e,o){return(o||t).querySelectorAll(e)},e.WATO.prototype.ready=function(e){(t.attachEvent?"complete"===t.readyState:"loading"!==t.readyState)?e():t.addEventListener("DOMContentLoaded",e)},e.WATO.prototype.ajax=function(e,t){var o=XMLHttpRequest.prototype.open;XMLHttpRequest.prototype.open=function(n,a,i,l,r){this.addEventListener("loadend",(function(){4===this.readyState&&-1!==a.indexOf(e)&&t()}),!1),o.call(this,n,a,i,l,r)}}}(window,document),function(e,t){"use strict";var o="en"===t.document.documentElement.getAttribute("lang");function n(){for(var t=e.qsa(".meta-navigation .badge--hollow"),o=t.length,n=0;n<o;n++){var a=t[n],i="block";"0"===a.textContent&&(i="none"),a.style.display=i}}console.log("window.location.pathname: ",t.location.pathname),-1!==t.location.pathname.indexOf("/ch/")&&t.document.documentElement.classList.add("kk_land_ch"),e.elem("#header",(function(t){t&&(console.log(4),n(),e.ajax("wishlist/add",n),e.ajax("cart/add",n))}));var a=setInterval((function(){n()}),42);setTimeout((function(){clearInterval(a)}),1e4),e.elem('#mainNavPrgRedirectionForm li[aria-label="Outdoor"]',(function(e){e&&e[0].addEventListener("click",(function(){t.iridion.push(["goal","mainNavi_outdoor","",!0])}))})),"/de/outdoor"===location.pathname&&(e.elem('#mainNavPrgRedirectionForm li[aria-label="Damen"] > .h-text-bold',(function(e){e&&e[0].classList.remove("h-text-bold")})),e.elem('#mainNavPrgRedirectionForm li[aria-label="Damen"] .secondLevel .h-text-bold',(function(e){e&&e[0].classList.remove("h-text-bold")})),e.elem('#mainNavPrgRedirectionForm li[aria-label="Damen"] .thirdLevel .h-text-bold',(function(e){e&&e[0].classList.remove("h-text-bold")})),e.elem('#mainNavPrgRedirectionForm [aria-label="Outdoor"] > a',(function(e){e&&e[0].classList.add("h-text-bold")}))),e.elem(".logoContainer img",(function(e){e&&e[0].setAttribute("src","https://media.hessnatur.com/kk/"+(o?"english/logo/hessnatur_en.svg":"global/logo/hessnatur_logo.svg"))}))}(new window.WATO,window);
