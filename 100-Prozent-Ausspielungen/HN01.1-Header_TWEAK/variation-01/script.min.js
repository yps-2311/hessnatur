!function(e,t){"use strict";void 0===e.WATO&&(e.WATO=function(){}),e.WATO.prototype.elem=function(e,n,o,a,i){var l,r=this||a,d=i||Date.now(),c=!1;return Date.now()-d>1e4?(n(!1),!1):("string"==typeof e?c=(l=t.querySelectorAll(e)).length>0:l=c=!0===e(),!0===c?n(l):setTimeout(r.elem.bind(null,e,n,o,r,d),o||20))},e.WATO.prototype.qs=function(e,n){return(n||t).querySelector(e)},e.WATO.prototype.qsa=function(e,n){return(n||t).querySelectorAll(e)},e.WATO.prototype.ready=function(e){(t.attachEvent?"complete"===t.readyState:"loading"!==t.readyState)?e():t.addEventListener("DOMContentLoaded",e)},e.WATO.prototype.ajax=function(e,t){var n=XMLHttpRequest.prototype.open;XMLHttpRequest.prototype.open=function(o,a,i,l,r){this.addEventListener("loadend",(function(){4===this.readyState&&-1!==a.indexOf(e)&&t()}),!1),n.call(this,o,a,i,l,r)}}}(window,document),function(e){"use strict";function t(){for(var t=e.qsa(".meta-navigation .badge--hollow"),n=t.length,o=0;o<n;o++){var a=t[o],i="block";"0"===a.textContent&&(i="none"),a.style.display=i}}-1!==window.location.pathname.indexOf("/ch/")&&window.document.documentElement.classList.add("kk_land_ch"),e.elem("#header",(function(n){n&&(t(),e.ajax("wishlist/add",t),e.ajax("cart/add",t))}));var n=setInterval((function(){t()}),42);setTimeout((function(){clearInterval(n)}),1e4),e.elem('#mainNavPrgRedirectionForm li[aria-label="Outdoor"]',(function(e){e&&e[0].addEventListener("click",(function(){window.iridion.push(["goal","mainNavi_outdoor","",!0])}))})),"/de/outdoor"===location.pathname&&(e.elem('#mainNavPrgRedirectionForm li[aria-label="Damen"] > .h-text-bold',(function(e){e&&e[0].classList.remove("h-text-bold")})),e.elem('#mainNavPrgRedirectionForm li[aria-label="Damen"] .secondLevel .h-text-bold',(function(e){e&&e[0].classList.remove("h-text-bold")})),e.elem('#mainNavPrgRedirectionForm li[aria-label="Damen"] .thirdLevel .h-text-bold',(function(e){e&&e[0].classList.remove("h-text-bold")})),e.elem('#mainNavPrgRedirectionForm [aria-label="Outdoor"] > a',(function(e){e&&e[0].classList.add("h-text-bold")}))),e.elem(".logoContainer img",(function(e){e&&e[0].setAttribute("src","https://media.hessnatur.com/kk/"+("en"===window.document.documentElement.getAttribute("lang")?"english/logo/hessnatur_en.svg":"global/logo/hessnatur_logo.svg"))}))}(new window.WATO);
