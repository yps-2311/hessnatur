...
(function (WATO) {
  ...
  WATO.prototype.sprint19goals = function () {
    ...
    _self.ready(function () {
      ...
      clickgoal(".sidebarNav ul a", "kk19_leftnavi", true); // KK: PS19 - Nutzung der Filter
      ...
      clickgoal(".js_backstopWrapper > .h-disp-block > a", "kk19_katbanner", true); // KK: PS19 - Klick auf eines der erste 6 Produkte
  ...
  WATO.prototype.sprint19 = function () {
     ...
     *
     */
    document.documentElement.classList.add('kk-ab19'); //    window.iridion.econda.push(["Sprint19Messtest", "V1"]);
                  ...
                  if (!firstVisitOnThisPage && savedSEOImages) {
                    try {
                      ...
                      savedSEOImages.forEach(function (img) {
                        kkSEOImages.push(img); // kkSEOImages[index].children[0].style.backgroundImage = 'url(' + img + ')';
                      });
                    } catch (e) {
                    ...
                    if (index === 0) {
                      WATO.elem('#kk-intro span', function (kkIntro) {
                        if (kkIntro) {
                          ...
                          cutTxt(WATO.qs('#kk-intro p'));
                          kkIntro[0].insertAdjacentHTML('afterend', '<a href="#kk-more">MEHR ERFAHREN</a>');
                        }
                      });
                    }
