	...
	if(window.innerWidth > 1023){
		...
		WATO.ps07global(function(){
			...
			if(!WATO.qs('.kk_nlmodal')){
				...
				// '<div class="reveal" data-animation-in="fade-in" data-animation-out="fade-out" role="dialog" aria-hidden="false" style="display: block; top: 185px;" tabindex="-1">'+
				...
				WATO.qs('body').insertAdjacentHTML('afterbegin', 
					'<div class="reveal-overlay kk_nlmodal">'+
						...
						'<div class="reveal" data-animation-in="fade-in" data-animation-out="fade-out" role="dialog" aria-hidden="false" style="display: block; top: 185px;" tabindex="-1">'+
							'<div class="row">'+
								'<div class="kk_left">'+
									'<div class="kk_badge">-30%<span>Exklusiv<br>Für Sie*</span></div>'+
								'</div>'+
								'<div class="column kk_right">'+
									'<p>Jetzt zum Newsletter anmelden </p>'+
									'<h4>30% VIP-RABATT</h4>'+
									'<p>EXKLUSIV FÜR UNSERE NEWSLETTER-FANS.</p>'+
									...
									'*Nicht kombinierbar mit anderen Aktionen. Ausgewählte Artikel sind von der Aktion ausgeschlossen. Gültig bis 21.11.2021.</small>'+
								'</div>'+
							'</div>'+
